...
public class FragmentModifyCamera extends Fragment {
    ...
    private ImageView imgMemoModify;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        imgMemoModify = view.findViewById(R.id.imgMemoModify);
        ...
        imgMemoModify.setImageURI(uri);

        // 사진 찍기 버튼 이벤트
        btnCaptureModify.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void sendPicture() {
        ...
        imgMemoModify.setImageBitmap( rotatedBmp );
        // 줄어든 이미지를 다시 저장한다.
